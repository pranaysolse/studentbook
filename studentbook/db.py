...
def init_db():
	"""
	this function can initialized the database by first calling the get_db function
	to connect to database it then execute default sql schema to create tables
	for application
	"""
	db = get_db()
